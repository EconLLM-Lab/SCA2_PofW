...
\textbf{Status.}
The companion package \cvp{}~3.0.1 is publicly released (PyPI, 2026-08-14 local / 2026-08-15 UTC) and used here as an instrument.
...
The framework is implemented in the open package \cvp{}~3.0.1, whose validity layer is deliberately model-free: no likelihood, no fitted null, and no language model.
...
This separation is a paper--package contract: the package is released on PyPI (version 3.0.1, 2026-08-14 local / 2026-08-15 UTC) and used here as an instrument.
...
Frozen score matrices, roles, networks, thresholds, and all run artifacts behind the tables are committed in the public repository \url{https://github.com/Bonorinoa/cvprofiles} at tag \texttt{paper-2026-08-18} (package version 3.0.1); the engine is released on PyPI.
...
\bibitem{capra2025} Gonzalez-Bonorino, A., C.~M. Capra, and E.~Pantoja (2025). ``LLMs Can Model Non-WEIRD Behavior: Experiments with Synthetic Cultural Agents.'' Accepted for publication in \textit{Research in Experimental Economics} 23: Artificial Intelligence and Experimental Methods.
