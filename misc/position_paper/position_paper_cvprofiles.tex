...
\section*{Author note}
This work was distributed as a working paper by the EconLLM Lab (August 2026); it has not been presented at a conference.
...
\bibitem{capra2025} Gonzalez-Bonorino, A., C.~M. Capra, and E.~Pantoja (2025). ``LLMs Can Model Non-WEIRD Behavior: Experiments with Synthetic Cultural Agents.'' Accepted for publication in \textit{Research in Experimental Economics} 23: Artificial Intelligence and Experimental Methods. arXiv:2501.06834.
...
\bibitem{cvprofiles} Gonzalez-Bonorino, A. (2026). \texttt{cvprofiles}: Construct-Validity Profiles as Partial Identification over Measurement Menus. Version 3.0.2, public repository (tag v3.0.2); version 3.0.1 on PyPI. \url{https://github.com/Bonorinoa/cvprofiles}.

\bibitem{hermesagent} Hermes Agent (Nous Research) (2026). \textit{Hermes Agent} [Computer software]. \url{https://hermes-agent.nousresearch.com}.
...
\bibitem{wallach2025} Wallach, H., M.~Desai, N.~Pangakis, A.~F. Cooper, et al. (2024). ``Evaluating Generative AI Systems Is a Social Science Measurement Challenge.'' \textit{NeurIPS 2024 Workshop on Evaluating Evaluations (EvalEval)}. arXiv:2411.10939.
