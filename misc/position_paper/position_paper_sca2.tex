...
Operator robustness & scenario, generator, selector, scorer/QC, materialized-data, and training-seed ablations & PARTIAL --- inference-time temperature scaling measured (pooled TVD $0.469\to0.332$ at $T=3$, top-option match unchanged); training-side ablations pending (extended-prompt bank, soft-\DPO{}/$|z|$ pruning, repeated seeds, deterministic-vs-legacy selector) & the conclusion depends on arbitrary or unstable upstream choices\\
\bottomrule
\end{tabularx}
\end{table}
