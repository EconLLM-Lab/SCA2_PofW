...
Alternatives exist if the criteria recommend them: \WVS{}/EVS country means, with the caveat of overlap with typical evaluation surfaces; Schwartz value country scores (PVQ/ESS); Hofstede dimensions; Inglehart--Welzel cultural-map coordinates \cite{inghlehart2005}; and the GLOBE project. Table~\ref{tab:anchor-sources} lists these candidates with their principal caveats. The method is agnostic to the specific source, so long as the criteria above hold.
