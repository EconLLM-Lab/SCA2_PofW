...
O\u{g}ut and Yin bound a regression coefficient using multiple nonlinear measurements of a latent regressor, reaching the same $[\theta_L,\theta_U]$ destination through curvature bounds and an ex ante factor-analytic separation rule rather than a nomological-network admissible set~\cite{ogutyin2026}.
...
The motivating fragility is documented: benchmark saturation is a recognized phenomenon and, even as capability reporting is near-universal, responsible-AI benchmark reporting remains spotty (Stanford HAI, AI Index 2026)~\cite{hai2026}; contamination is best treated as a spectrum rather than a flag, model errors are correlated far beyond chance~\cite{kim2025}, and prompt paraphrases can make virtually anything statistically significant~\cite{bauman2026}.
...
\bibitem{schennach2021} Schennach, S.~M. (2020). ``Mismeasured and Unobserved Variables.'' In \textit{Handbook of Econometrics}, Vol.~7A, 487--565. Elsevier.
...
\bibitem{truong2026} Truong, S., S.~Wang, A.~Wang, N.~Truong, A.~Reuel, N.~Haber, and S.~Koyejo (2026). ``Public AI Benchmarks Are Broken, But Are Private Benchmarks the Answer?'' Stanford AIMS.
...
\bibitem{hai2026} Stanford HAI (2026). ``The 2026 AI Index Report.'' \url{https://hai.stanford.edu/ai-index/2026-ai-index-report}.
\end{thebibliography}
